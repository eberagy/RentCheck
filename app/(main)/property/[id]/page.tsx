    ...
    <div className="min-h-screen bg-slate-50">
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3">
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-slate-400">Managed by</p>
                {landlord ? (
                  <Link href={`/landlord/${landlord.slug}`} className="mt-2 inline-flex items-center gap-2 group">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-1.5">
                        <span className="text-sm font-semibold text-slate-900 group-hover:text-navy-700">{landlord.display_name}</span>
            ...
            <div className="flex items-start gap-2.5 rounded-2xl border border-red-200 bg-red-50 px-4 py-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-xs text-red-600">
                  This property has unresolved housing code violations on record. Review the public records below for details.
                </p>
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <Button asChild size="sm" className="rounded-full bg-navy-600 text-white hover:bg-navy-700">

      ...
      <div className="space-y-6 text-sm leading-relaxed">
        <section>
          ...
          <ul className="mt-2 space-y-1 text-gray-600 list-disc list-inside">
            ...
            <li><strong>Review content:</strong> Reviews, ratings, and optional lease documents you submit.</li>
            <li><strong>Usage data:</strong> Search queries, pages visited, and interactions (via PostHog analytics).</li>
            <li><strong>Verification documents:</strong> Lease documents and landlord verification documents, stored securely in private Supabase Storage buckets. Never shared publicly.</li>
          </ul>
        </section>

    ...
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="text-slate-600">For privacy inquiries: <a href="mailto:privacy@vettrentals.com" className="text-navy-600 hover:underline">privacy@vettrentals.com</a></p>
        </section>
      </div>
    </div>
  )

...
import { FileText, Eye, Star, ArrowRight, Settings, CheckCircle2, AlertTriangle, Edit, Sparkles, Clock, Bell } from 'lucide-react'
      ...
      <div className="mx-auto grid max-w-[1320px] gap-6 px-4 py-7 sm:px-8 lg:grid-cols-[1fr_320px]">
            ...
            <div className="rounded-[24px] border border-slate-200 bg-white p-6 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-[16px] font-bold text-slate-900 flex items-center gap-2">
                  <Bell className="h-4 w-4 text-teal-600" aria-hidden="true" />
        ...
        <aside className="grid gap-4 self-start">
          ...
          <div className="rounded-xl border border-teal-200 bg-gradient-to-br from-teal-50 to-slate-50 p-5">
            <Sparkles className="h-[18px] w-[18px] text-teal" aria-hidden="true" />
            ...
            <Link href="/rights" className="mt-2.5 inline-flex items-center gap-1 text-[12.5px] font-semibold text-teal-900 hover:underline rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2">
              Read the guide <ArrowRight className="h-3 w-3" aria-hidden="true" />
            </Link>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-[18px]">
            ...
            <div className="grid gap-2">
              <Link href="/dashboard/settings" className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5 text-[13px] text-slate-700 hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:ring-offset-2">
                <span>Account settings</span>
                <Settings className="h-3.5 w-3.5 text-slate-400" aria-hidden="true" />
              </Link>
              <Link href="/search" className="flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2.5 text-[13px] text-slate-700 hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:ring-offset-2">

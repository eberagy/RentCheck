...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="max-w-none text-sm leading-relaxed space-y-6 text-slate-600">
        <section>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">3. User-Generated Content</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">4. Public Records Disclaimer</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">5. Not a Consumer Reporting Agency</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">6. Fair Housing Act</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">7. Section 230</h2>
        ...
        <section>
          ...
          <p>For questions about these Terms, contact us at <a href="mailto:legal@vettrentals.com" className="text-navy-600 hover:underline rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:ring-offset-2">legal@vettrentals.com</a>.</p>
        </section>
      </div>
    </div>
  )

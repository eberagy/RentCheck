...
export async function GET(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  // Public single-review fetch — approved-only, no user-scoped fields
  // after stripPrivateReviewFields. Same caching cadence as the rest
  // of the public read surface.
  return NextResponse.json(
    { review: stripPrivateReviewFields(data as unknown as ReviewWithLandlord) },
